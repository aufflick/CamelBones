...
#         = @Config::Config{'dlext', 'dlsrc'};
  ($dl_dlext, $dlsrc) = ('bundle','dl_dlopen.xs')
;
...
sub dl_findfile {
    ...
    my $dl_ext= 'bundle'; # $Config::Config{'dlext'} suffix for perl extensions
    my $dl_so = 'dylib'; # $Config::Config{'so'} suffix for shared libraries
