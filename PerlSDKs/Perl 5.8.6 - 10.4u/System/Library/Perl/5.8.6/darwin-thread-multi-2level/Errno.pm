...
"darwin-thread-multi-2level-8.0" or
	die "Errno architecture (darwin-thread-multi-2level-8.0) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
