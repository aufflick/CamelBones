 ...
 * Package name      : perl5
 * Source directory  : .
 * Configuration time: Wed Oct  7 21:25:40 EDT 2009
 * Configured by     : admin
 * Target system     : darwin gramps.local 9.8.0 darwin kernel version 9.8.0: wed jul 15 16:57:01 pdt 2009; root:xnu-1228.15.4~1release_ppc power macintosh 
 */
 ...
 */
#define PERL_INC_VERSION_LIST "5.8.8/darwin-thread-multi-2level","5.8.8","5.8.6","5.8.1/darwin-thread-multi-2level","5.8.1",0		/**/
 ...
 *	some shell.
 */
#define STARTPERL "#!/usr/bin/perl5.8.9"		/**/
