...
sub new {
    bless( {
        ...
        'APXS_BINDIR' => '/usr/bin',
        'APXS_EXTRA_CFLAGS' => '',
        'APXS_EXTRA_CPPFLAGS' => '-DDARWIN -DSIGPROCMASK_SETS_THREAD_MASK -no-cpp-precomp',
        ...
        'MODPERL_AP_LIBS' => '',
        'MODPERL_AR' => 'ar',
        'MODPERL_ARCHLIBEXP' => '/System/Library/Perl/5.8.8/darwin-thread-multi-2level',
        'MODPERL_CC' => 'cc',
        'MODPERL_CCCDLFLAGS' => ' ',
        'MODPERL_CCOPTS' => ' -arch i386 -arch ppc -g -pipe -fno-common -DPERL_DARWIN -no-cpp-precomp -fno-strict-aliasing -Wdeclaration-after-statement -I/usr/local/include -I/System/Library/Perl/5.8.8/darwin-thread-multi-2level/CORE -DMOD_PERL -DMP_COMPAT_1X -arch ppc -arch ppc64 -arch i386 -arch x86_64 -g -Os -pipe -arch ppc -arch ppc64 -arch i386 -arch x86_64 -pipe -DDARWIN -DSIGPROCMASK_SETS_THREAD_MASK -no-cpp-precomp',
        'MODPERL_CP' => 'cp',
        'MODPERL_CPPRUN' => 'cc -E',
        ...
        'MODPERL_INC' => '-I/private/var/tmp/apache_mod_perl/apache_mod_perl-101~38/mod_perl-2.0.2/src/modules/perl -I/private/var/tmp/apache_mod_perl/apache_mod_perl-101~38/mod_perl-2.0.2/xs -I/usr/include/apr-1 -I/usr/include/apr-1  -I/usr/include/apache2',
        'MODPERL_LD' => 'cc -mmacosx-version-min=10.5',
        'MODPERL_LDDLFLAGS' => '-arch i386 -arch ppc -bundle -undefined dynamic_lookup -L/usr/local/lib',
        'MODPERL_LDOPTS' => '  -arch i386 -arch ppc -L/usr/local/lib /System/Library/Perl/5.8.8/darwin-thread-multi-2level/auto/DynaLoader/DynaLoader.a -L/System/Library/Perl/5.8.8/darwin-thread-multi-2level/CORE -lperl -ldl -lm -lutil -lc',
        'MODPERL_LIB' => 'mod_perl.so',
        'MODPERL_LIBNAME' => 'mod_perl',
        'MODPERL_LIBPERL' => '/System/Library/Perl/5.8.8/darwin-thread-multi-2level/CORE/libperl.dylib',
        ...
        'MODPERL_PRIVLIBEXP' => '/System/Library/Perl/5.8.8',
        'MODPERL_RANLIB' => '/usr/bin/ar ts',
        'MODPERL_RM' => 'rm',
        'MODPERL_RM_F' => 'rm -f',
        'MODPERL_TEST_F' => 'test -f',
        'MODPERL_XSUBPP' => '$(MODPERL_PERLPATH) $(MODPERL_PRIVLIBEXP)/ExtUtils/xsubpp -typemap $(MODPERL_PRIVLIBEXP)/ExtUtils/typemap -typemap /private/var/tmp/apache_mod_perl/apache_mod_perl-101~38/mod_perl-2.0.2/lib/typemap',
        'MP_APR_LIB' => 'aprext',
        'MP_APXS' => '/usr/sbin/apxs',
        'MP_CCOPTS' => '-arch ppc -arch ppc64 -arch i386 -arch x86_64 -g -Os -pipe -arch ppc -arch ppc64 -arch i386 -arch x86_64 -pipe',
        'MP_COMPAT_1X' => 1,
        'MP_GENERATE_XS' => 1,
        'MP_LIBNAME' => 'mod_perl',
        'MP_USE_DSO' => 1,
        ...
        'cwd' => '/private/var/tmp/apache_mod_perl/apache_mod_perl-101~38/mod_perl-2.0.2',
        'dir' => undef,
